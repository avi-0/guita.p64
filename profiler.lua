--[[pod_format="raw",created="2024-10-02 18:45:58",modified="2024-10-05 19:04:01",revision=319]]
...
local function draw_cpu()
	print("\#0cpu:"..string.sub(stat(1)*100,1,5).."%",1,1,7)
end
