--[[pod_format="raw",created="2024-09-29 19:42:25",modified="2024-10-02 23:42:27",revision=711]]
include "guita.lua"
...
local box = guita.new(guita.box {p = 4, gap = 4, type = "column"})
...
local main = gui:attach(guita.scrollbox(box))
