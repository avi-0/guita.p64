--[[pod_format="raw",created="2024-09-29 19:42:25",modified="2024-10-05 21:04:11",revision=1094]]
include "guita.lua"
...
local box = guita.new(guita.box {p = 4, gap = 4, type = "row", box_justify = "center"})
